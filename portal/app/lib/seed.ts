...
async function seed() {
  ...
  const sampleUsers: UserDocument[] = [
    { id: "sharmaabh", name: "Abhishek Sharma", email: "sharmaabh@microsoft.com", alias: "sharmaabh", phoneNumber: "+91-98765-00001", isAdmin: true, createdAt: now, updatedAt: now },
  ...
  //   sharmaabh : MS, MD        jsmith  : WS, XD
  //   jdoe      : MS, MD        swilson : WS
  //   mjohnson  : MS, XD        priyam  : WS, XD
  //   ravi      : MS, XD        neha    : WS, XD
  //   arjun     : MS, MD
  //   akash     : MD, XD
  //
  // Category rosters:
  //   MS (5): sharmaabh[1], jdoe[2], mjohnson[3], ravi[4], arjun
  //   WS (4): jsmith[1], swilson[2], priyam, neha
  //   MD (2 teams): sharmaabh+jdoe[1], akash+arjun
  //   XD (3 teams): mjohnson+jsmith[1], ravi+priyam, akash+neha

  const sampleRegistrations: RegistrationDocument[] = [
    // ── Men's Singles (5 players → 8-draw, 3 byes) ──
    { id: "sharmaabh_MS", userId: "sharmaabh", userName: "Abhishek Sharma", category: "MS", status: "confirmed", seed: 1, createdAt: now, updatedAt: now },
    { id: "jdoe_MS", userId: "jdoe", userName: "John Doe", category: "MS", status: "confirmed", seed: 2, createdAt: now, updatedAt: now },
    { id: "mjohnson_MS", userId: "mjohnson", userName: "Mike Johnson", category: "MS", status: "confirmed", seed: 3, createdAt: now, updatedAt: now },
    { id: "ravi_MS", userId: "ravi", userName: "Ravi Kumar", category: "MS", status: "confirmed", seed: 4, createdAt: now, updatedAt: now },
    ...
    { id: "sharmaabh_MD", userId: "sharmaabh", userName: "Abhishek Sharma", category: "MD", status: "confirmed", seed: 1, partnerId: "jdoe", partnerName: "John Doe", partnerPhone: "+91-98765-00002", createdAt: now, updatedAt: now },
    { id: "jdoe_MD", userId: "jdoe", userName: "John Doe", category: "MD", status: "confirmed", partnerId: "sharmaabh", partnerName: "Abhishek Sharma", partnerPhone: "+91-98765-00001", createdAt: now, updatedAt: now },
    { id: "akash_MD", userId: "akash", userName: "Akash Patel", category: "MD", status: "confirmed", partnerId: "arjun", partnerName: "Arjun Reddy", partnerPhone: "+91-98765-00010", createdAt: now, updatedAt: now },
    { id: "arjun_MD", userId: "arjun", userName: "Arjun Reddy", category: "MD", status: "confirmed", partnerId: "akash", partnerName: "Akash Patel", partnerPhone: "+91-98765-00008", createdAt: now, updatedAt: now },
